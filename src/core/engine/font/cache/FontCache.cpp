...
namespace Radiant {
	...
	FontCache::FontCache(FontCache&& other) noexcept
	    : cacheManager(other.cacheManager), glyphImageCache(other.glyphImageCache),
	      smallBitmapCache(other.smallBitmapCache), cacheType(other.cacheType) {
	...
	FT_Size FontCache::lookupPointFontSize(FontCacheIdentifier fontFaceId, uint32_t width, uint32_t height,
	...
	FontCacheNode<FT_Glyph> FontCache::lookupGlyph(FontCacheIdentifier faceIdentifier, unsigned long charCode,
	...
	FontCacheNode<FTC_SBit> FontCache::lookupBitmap(FontCacheIdentifier faceIdentifier, unsigned long charCode,
	                                                int width, int height) {
		FTC_ImageTypeRec imageType{};
		imageType.face_id = &faceIdentifier;
		imageType.width = width;
	...
	FT_Error FontCache::requestFontFace(FTC_FaceID faceIdentifier, FT_Library freetype, FT_Pointer requestData,
	                                    FT_Face* fontFace) {
