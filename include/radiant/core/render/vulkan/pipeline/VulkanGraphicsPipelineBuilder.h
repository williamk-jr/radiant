...
namespace Radiant {
	...
	class VulkanGraphicsPipelineBuilder {
		public:
			...
			withVertexBindingDescription(uint32_t stride, VkVertexInputRate inputRate,
			...
			VulkanGraphicsPipelineBuilder& withRasterizationState(VkPolygonMode polygonMode,
			                                                      VkCullModeFlagBits cullMode, VkFrontFace frontFace,
			                                                      VulkanDepthBias depthBias, float lineWidth,
			...
			VulkanGraphicsPipelineBuilder& withShaderSlang(std::string stageName, std::filesystem::path shaderPath,
