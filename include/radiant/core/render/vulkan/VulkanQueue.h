...
namespace Radiant {
	...
	class VulkanQueue {
		public:
			 ...
			 * @param std::vector<VulkanSemaphoreSubmitInfo>* A vector of semaphores to signal once execution of command
			 * buffers is complete.
			 ...
			 * @param VulkanSemaphoreSubmitInfo A pointer to a semaphore to signal once execution of the command buffer
			 * is complete.
			 * @param VulkanFence& A reference to a valid vulkan fence to wait on before work can be submitted.
			 */
			// void submit(VulkanCommandBuffer& commandBuffer, VulkanSemaphoreSubmitInfo* waitSemaphore,
